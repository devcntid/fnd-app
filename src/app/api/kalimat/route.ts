...
export async function GET(request: Request) {
  ...
  try {
    ...
    console.log('Kalimat API - idEmployee:', idEmployee)
    ...
    // 1. Capaian Kalimat: sum from corez_transaksi (verified) or corez_transaksi_scrap (unverified)
    // where id_crm = id_employee and id_jenis = 4
    let capaian = 0
    ...
    if (verified === 'verified') {
      ...
      if (isCurrentYear) {
        ...
        capaian = Number(capaianResult[0]?.total) || 0
        console.log(
          'Kalimat API - Cash Unverified capaian (current year):',
          capaian
        )
      } else {
        ...
        capaian = Number(capaianResult[0]?.total) || 0
        console.log(
          'Kalimat API - Cash Unverified capaian (past year):',
          capaian
        )
      }
      ...
      if (isCurrentYear) {
        ...
        capaian = Number(capaianResult[0]?.total) || 0
        console.log(
          'Kalimat API - Bank Unverified capaian (current year):',
          capaian
        )
      } else {
        ...
        capaian = Number(capaianResult[0]?.total) || 0
        console.log(
          'Kalimat API - Bank Unverified capaian (past year):',
          capaian
        )
      }
    }
    ...
    // For Kalimat, we consider donatur as "sudah dijemput" if they have transactions
