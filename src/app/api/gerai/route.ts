...
export async function GET(request: Request) {
  ...
  try {
    ...
    console.log('Gerai API - idEmployee:', idEmployee)
    ...
    // 1. Capaian Gerai: sum from corez_transaksi (verified)_options or corez_transaksi_scrap (unverified)
    // where id_crm = id_employee and id_jenis = 7
    let capaian = 0
    ...
    if (verified === 'verified') {
      ...
      console.log('Gerai API - Cash Unverified capaian:', capaian)
