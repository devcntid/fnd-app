...
export default function HomePage() {
  ...
  const renderTabContent = () => {
    switch (activeTab) {
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-2xl p-4 shadow-sm space-y-4">
              <div className="flex justify-between items-center flex-wrap gap-2">
                <h3 className="font-semibold text-lg text-gray-800">Ringkasan Timsil</h3>
                <div className="flex items-center gap-2">
                  ...
                  <select defaultValue="Juli" className="bg-gray-100 border-gray-200 border text-gray-800 text-xs font-semibold p-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                    <option>Juli</option>
                  </select>
                </div>
              </div>
              <div className="text-center">
                ...
                <p className="text-sm font-semibold text-gray-600">Capaian Timsil</p>
              </div>
            ...
            <div className="bg-white rounded-2xl p-4 shadow-sm">
              <div className="flex justify-between items-center">
                <h3 className="font-semibold text-lg text-gray-800">Leaderboard Timsil</h3>
                <select defaultValue="7" className="bg-gray-100 border-gray-200 border text-gray-800 text-xs font-semibold p-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
              ...
              <div className="space-y-4">
                <p className="text-center text-sm text-gray-600">Belum ada data untuk periode ini.</p>
              </div>
            </div>
          </div>
        )
      ...
      case 'kalimat':
        return (
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-2xl p-4 shadow-sm space-y-4">
              <div className="flex justify-between items-center flex-wrap gap-2">
                <h3 className="font-semibold text-lg text-gray-800">Ringkasan Kalimat</h3>
                <div className="flex items-center gap-2">
                  <select className="bg-gray-100 border-gray-200 border text-gray-800 text-xs font-semibold p-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                    <option>Nasional</option>
                    <option>Bandung</option>
              ...
              <div className="text-center">
                ...
                <p className="text-sm font-semibold text-gray-600">Total Donasi</p>
              </div>
              <div className="grid grid-cols-3 gap-4 text-center border-t border-gray-100 pt-4">
                <div>
                  <p className="text-xl font-bold bg-gradient-to-r from-blue-400 to-blue-600 bg-clip-text text-transparent">
            ...
            <div className="bg-white rounded-2xl p-4 shadow-sm">
              <div className="flex justify-between items-center">
                <h3 className="font-semibold text-lg text-gray-800">Leaderboard Kalimat</h3>
                <select defaultValue="7" className="bg-gray-100 border-gray-200 border text-gray-800 text-xs font-semibold p-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                  <option value="all">Semua</option>
                  <option value="7">Juli</option>
                  <option value="6">Juni</option>
      ...
      case 'summary':
        ...
        return (
          <div className="space-y-4">
            <h2 className="text-2xl font-bold text-white">Total Capaian Fundraising</h2>
            <div className="bg-white rounded-2xl p-4 shadow-sm space-y-4">
              <div className="text-center pb-4 border-b border-gray-200">
                <p className="text-sm font-semibold text-gray-600">Total Capaian</p>
              ...
              <div className="flex justify-between items-center flex-wrap gap-2 pt-2">
                <h3 className="font-semibold text-lg text-gray-800">Detail Capaian</h3>
                <div className="flex items-center gap-2">
                  <select className="bg-gray-100 border-gray-200 border text-gray-800 text-xs font-semibold p-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                    <option>Nasional</option>
                    <option>Bandung</option>
            ...
            <div className="bg-white rounded-2xl p-4 shadow-sm space-y-4">
              <div className="space-y-2 text-sm">
                {['Timsil','Kalimat','Event','Gerai','Mitra Unggul','Corporate','MPZ'].map((label, idx)=> (
                  <div key={label} className={`flex justify-between p-2 rounded-lg ${idx%2===0? 'bg-gray-50':''}`}>
      ...
      default:
        return (
          <div className="space-y-4">
            <h2 className="text-2xl font-bold text-white">Aktivitas {activeTab}</h2>
            <div className="bg-white rounded-2xl p-4 shadow-sm">
              <p className="text-center text-gray-600">Konten untuk {activeTab} akan segera tersedia.</p>
            </div>
          </div>
        )
    }
  ...
  return (
    <main className="p-4 space-y-5">
      ...
      <ActionButtons onToolsClick={() => {}} onLaporanDonaturClick={() => {}} />
