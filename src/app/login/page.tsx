...
export default function LoginPage() {
  ...
  return (
    <div
      className="w-full max-w-md mx-auto min-h-screen flex items-center justify-center"
      style={{ backgroundColor: '#0f2552' }}
    >
      <main className="p-6 w-full relative">
        <div className="bg-white rounded-3xl w-full shadow-2xl overflow-hidden">
          <div
            ...
            style={{
              backgroundImage: `linear-gradient(to bottom, rgba(30, 74, 179, 0.7), rgba(36, 83, 199, 0.7)), url('https://i.imgur.com/fE9xsga.jpeg')`,
            }}
          >
